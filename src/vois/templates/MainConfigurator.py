...
class MainConfigurator(page.page):
    ...
    def createLeft(self):
        ...
        cr1 = v.Card(flat=True, children=[widgets.HBox([ct, cc])], width=netwidth, max_width=netwidth, style_='overflow: hidden;')
        ...
        images = [{ "name": '%d'%x, "image": 'https://www.daigio.it/JRC/WallpapersSmall/%d.jpg'%x, "max_width": 150, "max_height": 100 } for x in range(60)]
