...
class Test_colorPicker:
    ...
    def test_simple_init(self, ipywidgets_vois_runner, page_session, assert_vois_compare_image,
        ...
        canvas_1_locator = page_session.locator('canvas').locator('..').locator('..') # get_by_role("menu").locator("canvas")
        ...
        canvas_2_locator = page_session.locator("canvas").nth(1).locator('..').locator('..') # get_by_role("menu").locator("canvas")
    ...
    def test_clicks(self, ipywidgets_vois_runner, page_session, assert_vois_compare_image, assert_vois_path_images):
        ...
        path_before = assert_vois_compare_image(image=canvas_1_locator.screenshot(animations='disabled'), postfix='1_before')

        canvas_1_locator.click(position={'x': 50, 'y': 50})

        path_after = assert_vois_compare_image(image=canvas_1_locator.screenshot(animations='disabled'), postfix='1_after')
