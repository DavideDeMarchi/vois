...
class Test_radio:
    ...
    def test_change(self, ipywidgets_vois_runner, page_session, assert_vois_compare_image,
        ...
        page_session.locator("div").filter(has_text=re.compile(r"^B$")).locator("div").nth(1).click()
        page_session.locator("div").filter(has_text=re.compile(r"^C$")).locator("div").nth(1).click()
